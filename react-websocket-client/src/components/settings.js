...
function Settings({startupData}) {
    ...
    <SettingsDropdown startUpCheck={startupData.framesize} labelName={"Framesize"} controlVar={"framesize"}/>
    {/*<SettingsSlider startUpCheck={startupData.framesize} labelName={"Framesize"} controlVar={"framesize"} minVal={0} maxVal={14}/>*/}
